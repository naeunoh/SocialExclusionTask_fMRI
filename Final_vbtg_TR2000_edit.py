...
p1image = visual.ImageStim(win, image='pimages/%s/%s' %(date,p1), pos=(-7,7), size=(5,5)) 
p3image = visual.ImageStim(win, image='pimages/%s/%s' %(date,p3), pos=(7,7), size=(5,5)) 

ready_screen = visual.TextStim(win, text="준비하세요", height=1.2, color="#000000")
